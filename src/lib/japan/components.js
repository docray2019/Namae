...
export const COMPONENTS = [
  ...
  { k: '仙',   romaji: ['sen'], kana: 'せん', cat: 'religion', role: 'prefix', strokes: 5,
    fr: 'immortel, sage taoïste, ermite', ex: 'Sen-dai 仙台 — « la terrasse de l’immortel »',
    note: 'Sage taoïste ou ermite des montagnes ; lecture commune sen-.' },
  ...
  { k: '沖',   romaji: ['oki', 'chuu'], kana: 'おき・ちゅう', cat: 'eau', role: 'prefix', strokes: 7,
    fr: 'haute mer, large', ex: 'Oki-nawa 沖縄 — « corde du large »',
    note: 'Le large, au-delà du rivage ; aussi sens figuré de « lointain ».' },
  ...
  { k: '倉',   romaji: ['kura', 'gura', 'sou'], kana: 'くら・そう', cat: 'urbain', role: 'suffix', strokes: 10,
    fr: 'entrepôt, grenier', ex: 'Kama-kura 鎌倉 — « entrepôt à la faucille »',
    note: 'Bâtiment de stockage (riz, marchandises) ; donne son nom au shogunat de Kamakura.' },
  ...
  { k: '横',   romaji: ['yoko'], kana: 'よこ', cat: 'direction', role: 'prefix', strokes: 15,
    fr: 'côté, latéral, horizontal', ex: 'Yoko-hama 横浜 — « grève latérale »',
    note: 'Sur le côté, en travers ; opposé de 縦 (tate, vertical).' },
  ...
  { k: '渋',   romaji: ['shibu', 'shibui', 'juu'], kana: 'しぶ・じゅう', cat: 'qualite', role: 'prefix', strokes: 11,
    fr: 'âpre, astringent, austère', ex: 'Shibu-ya 渋谷 — « vallée âpre »',
    note: 'Goût astringent (kaki vert) ; au figuré, sobre, austère. Forme traditionnelle : 澁.' },
  ...
  { k: '富',   romaji: ['fu', 'tomi'], kana: 'ふ・とみ', cat: 'qualite', role: 'prefix', strokes: 12,
    fr: 'richesse, abondance', ex: 'Fuji-san 富士山 — Fu-ji',
    note: '富 « richesse » + 士 dans le mont Fuji : lecture phonétique sans rapport étymologique.' },
  { k: '士',   romaji: ['shi', 'ji'], kana: 'し・じ', cat: 'qualite', role: 'both', strokes: 3,
    fr: 'samouraï, lettré, gentilhomme', ex: 'Fu-ji 富士山',
    note: 'Guerrier ou homme de lettres ; souvent lecture phonétique « ji ».' },
  { k: '名',   romaji: ['na', 'mei', 'myou'], kana: 'な・めい', cat: 'qualite', role: 'prefix', strokes: 6,
    fr: 'nom, renom, célèbre', ex: 'Nago-ya 名古屋 — « demeure de renom »',
    note: 'Nom propre ou réputation ; donne aussi « namae » 名前.' },
  { k: '須',   romaji: ['su'], kana: 'す', cat: 'qualite', role: 'both', strokes: 12,
    fr: 'devoir, nécessité (phonétique en toponymie)', ex: 'Yoko-suka 横須賀, Su-ma 須磨',
    note: 'Sens littéraire rare ; en toponymie, surtout lecture phonétique « su ».' },
  { k: '賀',   romaji: ['ga', 'ka'], kana: 'が・か', cat: 'qualite', role: 'suffix', strokes: 12,
    fr: 'félicitation, célébration', ex: 'Yoko-suka 横須賀, Sa-ga 佐賀',
    note: 'Caractère auspicieux ; lectures phonétiques fréquentes.' },
  { k: '鎌',   romaji: ['kama'], kana: 'かま', cat: 'qualite', role: 'prefix', strokes: 18,
    fr: 'faucille, faux', ex: 'Kama-kura 鎌倉',
    note: 'Outil agricole ; donne son nom au shogunat de Kamakura (1185-1333).' },
  { k: '札',   romaji: ['satsu', 'sap', 'fuda'], kana: 'さつ・ふだ', cat: 'qualite', role: 'prefix', strokes: 5,
    fr: 'planchette, étiquette, billet', ex: 'Sap-poro 札幌',
    note: 'Tablette de bois (édit, billet, étiquette).' },
  { k: '幌',   romaji: ['horo', 'poro'], kana: 'ほろ・ぽろ', cat: 'qualite', role: 'suffix', strokes: 13,
    fr: 'rideau, bâche', ex: 'Sap-poro 札幌',
    note: 'Origine probable : transcription du mot aïnou sat-poro-pet (« rivière large et sèche »).' },
  { k: '那',   romaji: ['na'], kana: 'な', cat: 'qualite', role: 'both', strokes: 7,
    fr: 'lecture phonétique « na » (toponymie)', ex: 'Na-ha 那覇, Na-su 那須',
    note: 'Caractère utilisé surtout pour sa lecture na en transcription.' },
  { k: '覇',   romaji: ['ha'], kana: 'は', cat: 'qualite', role: 'suffix', strokes: 19,
    fr: 'hégémonie, suprématie', ex: 'Na-ha 那覇',
    note: 'Sens premier rare en toponymie ; emploi phonétique « ha ».' },
  { k: '奈',   romaji: ['na', 'nai'], kana: 'な', cat: 'qualite', role: 'both', strokes: 8,
    fr: 'lecture phonétique « na » (toponymie ancienne)', ex: 'Na-ra 奈良, Kana-gawa 神奈川',
    note: 'Caractère phonétique fréquent dans la toponymie ancienne.' },
  { k: '良',   romaji: ['yoshi', 'ryou', 'ra'], kana: 'よし・りょう', cat: 'qualite', role: 'both', strokes: 7,
    fr: 'bon, excellent', ex: 'Na-ra 奈良',
    note: 'Bon, agréable ; lecture phonétique « ra » dans Nara.' },
  { k: '静',   romaji: ['shizu', 'sei', 'jou'], kana: 'しず・せい', cat: 'qualite', role: 'prefix', strokes: 14,
    fr: 'calme, paisible, silencieux', ex: 'Shizu-oka 静岡 — « colline paisible »',
    note: 'Tranquillité, sérénité. Forme traditionnelle : 靜.' },
  { k: '熊',   romaji: ['kuma', 'guma', 'yuu'], kana: 'くま', cat: 'qualite', role: 'prefix', strokes: 14,
    fr: 'ours', ex: 'Kuma-moto 熊本 — « origine de l’ours »',
    note: 'L’ours ; fréquent dans les toponymes du Kyūshū et de la côte ouest.' },
  { k: '鹿',   romaji: ['shika', 'ka', 'roku'], kana: 'しか・か', cat: 'qualite', role: 'both', strokes: 11,
    fr: 'cerf, biche', ex: 'Ka-goshima 鹿児島',
    note: 'Le cerf ; lecture phonétique « ka » dans Kagoshima.' },
  { k: '児',   romaji: ['ji', 'go', 'ni'], kana: 'じ・に', cat: 'qualite', role: 'both', strokes: 7,
    fr: 'enfant, jeune', ex: 'Kago-shima 鹿児島',
    note: 'Enfant ; lecture phonétique « go » dans Kagoshima. Forme traditionnelle : 兒.' },
  { k: '縄',   romaji: ['nawa', 'jou'], kana: 'なわ・じょう', cat: 'qualite', role: 'suffix', strokes: 15,
    fr: 'corde', ex: 'Oki-nawa 沖縄 — « corde du large »',
    note: 'Corde tressée ; évoque sans doute les chapelets d’îles. Forme : 繩.' },
  { k: '盛',   romaji: ['mori', 'sei', 'jou'], kana: 'もり・せい', cat: 'qualite', role: 'both', strokes: 11,
    fr: 'prospère, abondant, en plein essor', ex: 'Mori-oka 盛岡 — « colline prospère »',
    note: 'Plénitude, abondance, apogée.' },
